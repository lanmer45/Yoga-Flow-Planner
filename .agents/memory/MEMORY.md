...
- [Flow Planner chime / mobile audio](flow-planner-audio.md) — iOS mute switch silences the Web Audio chime; fix needs audioSession 'playback' + in-gesture silent-buffer unlock (trade-offs in file).
